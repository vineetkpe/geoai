...
- **Multi-LLM Parallel Execution**: Queries Gemini 3.1 Flash-Lite, GPT-4o Mini, Claude 3.5 Haiku, and Perplexity Sonar concurrently with graceful error isolation per model.
